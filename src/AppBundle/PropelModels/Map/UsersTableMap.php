...
use AppBundle\PropelModels\Users;
use AppBundle\PropelModels\UsersQuery;
...
class UsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AppBundle.PropelModels.Map.UsersTableMap';
     ...
     */
    const OM_CLASS = '\\AppBundle\\PropelModels\\Users';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.AppBundle.PropelModels.Users';
    ...
    /**
     * the column name for the user_nick_name field
     */
    const COL_USER_NICK_NAME = 'users.user_nick_name';
     ...
     */
    const COL_DELETED = 'users.deleted';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'UserName', 'UserNickName', 'LastUpdated', 'Deleted', ),
        self::TYPE_CAMELNAME     => array('id', 'userName', 'userNickName', 'lastUpdated', 'deleted', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_USER_NAME, UsersTableMap::COL_USER_NICK_NAME, UsersTableMap::COL_LAST_UPDATED, UsersTableMap::COL_DELETED, ),
        self::TYPE_FIELDNAME     => array('id', 'user_name', 'user_nick_name', 'last_updated', 'deleted', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'UserName' => 1, 'UserNickName' => 2, 'LastUpdated' => 3, 'Deleted' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'userName' => 1, 'userNickName' => 2, 'lastUpdated' => 3, 'deleted' => 4, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_USER_NAME => 1, UsersTableMap::COL_USER_NICK_NAME => 2, UsersTableMap::COL_LAST_UPDATED => 3, UsersTableMap::COL_DELETED => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'user_name' => 1, 'user_nick_name' => 2, 'last_updated' => 3, 'deleted' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_USER_NICK_NAME);
            $criteria->addSelectColumn(UsersTableMap::COL_LAST_UPDATED);
            $criteria->addSelectColumn(UsersTableMap::COL_DELETED);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.user_name');
            $criteria->addSelectColumn($alias . '.user_nick_name');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppBundle\PropelModels\Users) { // it's a model object
