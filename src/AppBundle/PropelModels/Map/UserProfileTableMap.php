...
namespace AppBundle\PropelModels\Map;

use AppBundle\PropelModels\UserProfile;
use AppBundle\PropelModels\UserProfileQuery;
...
class UserProfileTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AppBundle.PropelModels.Map.UserProfileTableMap';
     ...
     */
    const OM_CLASS = '\\AppBundle\\PropelModels\\UserProfile';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.AppBundle.PropelModels.UserProfile';
     ...
     */
    const COL_ID = 'user_profile.id';

    /**
     * the column name for the about_me field
     */
    const COL_ABOUT_ME = 'user_profile.about_me';

    /**
     * the column name for the profession field
     */
    const COL_PROFESSION = 'user_profile.profession';

    /**
     * the column name for the birth_date field
     */
    const COL_BIRTH_DATE = 'user_profile.birth_date';

    /**
     * the column name for the user_id field
     */
    const COL_USER_ID = 'user_profile.user_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'AboutMe', 'Profession', 'BirthDate', 'UserId', ),
        self::TYPE_CAMELNAME     => array('id', 'aboutMe', 'profession', 'birthDate', 'userId', ),
        self::TYPE_COLNAME       => array(UserProfileTableMap::COL_ID, UserProfileTableMap::COL_ABOUT_ME, UserProfileTableMap::COL_PROFESSION, UserProfileTableMap::COL_BIRTH_DATE, UserProfileTableMap::COL_USER_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'about_me', 'profession', 'birth_date', 'user_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'AboutMe' => 1, 'Profession' => 2, 'BirthDate' => 3, 'UserId' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'aboutMe' => 1, 'profession' => 2, 'birthDate' => 3, 'userId' => 4, ),
        self::TYPE_COLNAME       => array(UserProfileTableMap::COL_ID => 0, UserProfileTableMap::COL_ABOUT_ME => 1, UserProfileTableMap::COL_PROFESSION => 2, UserProfileTableMap::COL_BIRTH_DATE => 3, UserProfileTableMap::COL_USER_ID => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'about_me' => 1, 'profession' => 2, 'birth_date' => 3, 'user_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AppBundle\\PropelModels\\UserProfile');
        $this->setPackage('src.AppBundle.PropelModels');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('about_me', 'AboutMe', 'VARCHAR', true, 255, null);
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UserProfileTableMap::COL_ID);
            $criteria->addSelectColumn(UserProfileTableMap::COL_ABOUT_ME);
            $criteria->addSelectColumn(UserProfileTableMap::COL_PROFESSION);
            $criteria->addSelectColumn(UserProfileTableMap::COL_BIRTH_DATE);
            $criteria->addSelectColumn(UserProfileTableMap::COL_USER_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppBundle\PropelModels\UserProfile) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(UserProfileTableMap::DATABASE_NAME);
            $criteria->add(UserProfileTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(UserProfileTableMap::COL_ID) && $criteria->keyContainsValue(UserProfileTableMap::COL_ID) ) {
