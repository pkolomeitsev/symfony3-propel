...
use AppBundle\Propel\Generator\Builder\Om\PropelModel;
 ...
 *
 *
 * @package    propel.generator.src.AppBundle.PropelModels.Base
 */
abstract class UserProfile extends PropelModel implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\PropelModels\\Map\\UserProfileTableMap';
    ...
    */
    ...
    /**
     * Initializes internal state of AppBundle\PropelModels\Base\UserProfile object.
     */
     ...
     * @return $this|\AppBundle\PropelModels\UserProfile The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[UserProfileTableMap::COL_ID] = true;
        }
    ...
    public function setAboutMe($v)
    {
        ...
        if ($this->about_me !== $v) {
            $this->about_me = $v;
            $this->modifiedColumns[UserProfileTableMap::COL_ABOUT_ME] = true;
        }
    ...
    public function setProfession($v)
    {
        ...
        if ($this->profession !== $v) {
            $this->profession = $v;
            $this->modifiedColumns[UserProfileTableMap::COL_PROFESSION] = true;
        }
    ...
    public function setBirthDate($v)
    {
        ...
        if ($this->birth_date !== null || $dt !== null) {
            if ($this->birth_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->birth_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UserProfileTableMap::COL_BIRTH_DATE] = true;
            }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[UserProfileTableMap::COL_USER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UserProfileTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserProfileTableMap::translateFieldName('AboutMe', TableMap::TYPE_PHPNAME, $indexType)];
            $this->about_me = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserProfileTableMap::translateFieldName('Profession', TableMap::TYPE_PHPNAME, $indexType)];
            $this->profession = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserProfileTableMap::translateFieldName('BirthDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->birth_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UserProfileTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = UserProfileTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\AppBundle\\PropelModels\\UserProfile'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[UserProfileTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . UserProfileTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(UserProfileTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(UserProfileTableMap::COL_ABOUT_ME)) {
            $modifiedColumns[':p' . $index++]  = 'about_me';
        }
        if ($this->isColumnModified(UserProfileTableMap::COL_PROFESSION)) {
            $modifiedColumns[':p' . $index++]  = 'profession';
        }
        if ($this->isColumnModified(UserProfileTableMap::COL_BIRTH_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'birth_date';
        }
        if ($this->isColumnModified(UserProfileTableMap::COL_USER_ID)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getAboutMe(),
            $keys[2] => $this->getProfession(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\PropelModels\UserProfile
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setAboutMe($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setProfession($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\PropelModels\UserProfile The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserProfileTableMap::COL_ID)) {
            $criteria->add(UserProfileTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(UserProfileTableMap::COL_ABOUT_ME)) {
            $criteria->add(UserProfileTableMap::COL_ABOUT_ME, $this->about_me);
        }
        if ($this->isColumnModified(UserProfileTableMap::COL_PROFESSION)) {
            $criteria->add(UserProfileTableMap::COL_PROFESSION, $this->profession);
        }
        if ($this->isColumnModified(UserProfileTableMap::COL_BIRTH_DATE)) {
            $criteria->add(UserProfileTableMap::COL_BIRTH_DATE, $this->birth_date);
        }
        if ($this->isColumnModified(UserProfileTableMap::COL_USER_ID)) {
            $criteria->add(UserProfileTableMap::COL_USER_ID, $this->user_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\PropelModels\UserProfile (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\PropelModels\UserProfile Clone of current object.
     * @throws PropelException
     */
