 ...
 */
abstract class Users extends PropelModel implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\PropelModels\\Map\\UsersTableMap';
    ...
    */
    ...
    /**
     * The value for the user_nick_name field.
     *
     * @var        string
     */
    protected $user_nick_name;
    ...
    /**
     * Initializes internal state of AppBundle\PropelModels\Base\Users object.
     */
    ...
    /**
     * Get the [user_nick_name] column value.
     *
     * @return string
     */
     ...
     * @return $this|\AppBundle\PropelModels\Users The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [user_nick_name] column.
     *
     * @param string $v new value
     * @return $this|\AppBundle\PropelModels\Users The current object (for fluent API support)
     */
    public function setUserNickName($v)
    {
        ...
        if ($this->user_nick_name !== $v) {
            $this->user_nick_name = $v;
            $this->modifiedColumns[UsersTableMap::COL_USER_NICK_NAME] = true;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[UsersTableMap::COL_DELETED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UsersTableMap::translateFieldName('UserNickName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_nick_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UsersTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->last_updated = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UsersTableMap::translateFieldName('Deleted', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\AppBundle\\PropelModels\\Users'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_USER_NICK_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'user_nick_name';
        }
        if ($this->isColumnModified(UsersTableMap::COL_LAST_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = 'last_updated';
        }
        if ($this->isColumnModified(UsersTableMap::COL_DELETED)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'user_name':
                        ...
                        break;
                    case 'user_nick_name':
                        $stmt->bindValue($identifier, $this->user_nick_name, PDO::PARAM_STR);
                        break;
                    case 'last_updated':
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\PropelModels\Users
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setUserNickName($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setLastUpdated($arr[$keys[3]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\PropelModels\Users The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_USER_NICK_NAME)) {
            $criteria->add(UsersTableMap::COL_USER_NICK_NAME, $this->user_nick_name);
        }
        if ($this->isColumnModified(UsersTableMap::COL_LAST_UPDATED)) {
            $criteria->add(UsersTableMap::COL_LAST_UPDATED, $this->last_updated);
        }
        if ($this->isColumnModified(UsersTableMap::COL_DELETED)) {
            $criteria->add(UsersTableMap::COL_DELETED, $this->deleted);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\PropelModels\Users (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\PropelModels\Users Clone of current object.
     * @throws PropelException
     */
