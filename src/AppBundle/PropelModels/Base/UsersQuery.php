...
use \Exception;
use \PDO;
use AppBundle\PropelModels\Users as ChildUsers;
use AppBundle\PropelModels\UsersQuery as ChildUsersQuery;
 ...
 * @method     ChildUsersQuery orderByUserNickName($order = Criteria::ASC) Order by the user_nick_name column
 * @method     ChildUsersQuery orderByLastUpdated($order = Criteria::ASC) Order by the last_updated column
 * @method     ChildUsersQuery orderByDeleted($order = Criteria::ASC) Order by the deleted column
 *
 ...
 * @method     ChildUsersQuery groupByUserNickName() Group by the user_nick_name column
 * @method     ChildUsersQuery groupByLastUpdated() Group by the last_updated column
 * @method     ChildUsersQuery groupByDeleted() Group by the deleted column
 *
 ...
 * @method     ChildUsers findOneByUserNickName(string $user_nick_name) Return the first ChildUsers filtered by the user_nick_name column
 ...
 * @method     ChildUsers findOneByDeleted(int $deleted) Return the first ChildUsers filtered by the deleted column *
 ...
 * @method     ChildUsers requireOneByUserNickName(string $user_nick_name) Return the first ChildUsers filtered by the user_nick_name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUsers requireOneByDeleted(int $deleted) Return the first ChildUsers filtered by the deleted column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUsers[]|ObjectCollection findByUserNickName(string $user_nick_name) Return ChildUsers objects filtered by the user_nick_name column
 ...
 * @method     ChildUsers[]|ObjectCollection findByDeleted(int $deleted) Return ChildUsers objects filtered by the deleted column
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \AppBundle\PropelModels\Base\UsersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\AppBundle\\PropelModels\\Users', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, user_name, user_nick_name, last_updated, deleted FROM users WHERE id = :p0';
        try {
    ...
    /**
     * Filter the query on the user_nick_name column
     *
     * Example usage:
     * <code>
     * $query->filterByUserNickName('fooValue');   // WHERE user_nick_name = 'fooValue'
     * $query->filterByUserNickName('%fooValue%', Criteria::LIKE); // WHERE user_nick_name LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByUserNickName($userNickName = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsersTableMap::COL_USER_NICK_NAME, $userNickName, $comparison);
    }
    ...
    public function filterByDeleted($deleted = null, $comparison = null)
    {
        if (is_array($deleted)) {
            ...
            if (isset($deleted['min'])) {
                $this->addUsingAlias(UsersTableMap::COL_DELETED, $deleted['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($deleted['max'])) {
                $this->addUsingAlias(UsersTableMap::COL_DELETED, $deleted['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsersTableMap::COL_DELETED, $deleted, $comparison);
    }
